                            ...
                            <div class="col-md-12">
                                <form id="login-form" action="#" method="post" role="form" style="display: block;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="ID" id="id" tabindex="1" class="form-control" placeholder="Introduzca Id..." value="" required>
                                        </div>
                                    </div>
                                    <div class="row editar"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="Producto" id="producto" tabindex="2" class="form-control" placeholder="Introduzca producto..." value="" required>
                                        </div>
                                    </div>
                                    <div class="row  editar"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="Precio" id="precio" tabindex="2" class="form-control" placeholder="Introduzca precio..." value="" required>
                                        </div>
                                    </div>
                                    <div class="row editar"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="Precio/Um" id="precio/um" tabindex="4" class="form-control" placeholder="Introduzca precio * unidad de medida..." value="">
                                        </div>
                                    </div>
                                    <div class="row editar"></div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="Descuento" id="descuento" tabindex="4" class="form-control" placeholder="Introduzca descuento..." value="">
                                        </div>
                                    </div>
                                    <div class="row editar">
                                        <div class="form-group">
                                        <div class="col-md-8 etiquetas aniadir">Introduzca imagen producto</div>
                                        <div class="col-md-4">
                                            <button type="button" class="btn aniadir">A&ntilde;adir</button>
                                        </div>
                                    </div>
                                    </div>
                                    <div class="form-group">
