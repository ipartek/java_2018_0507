        ...
        <div class="row">
            <div class="col-xs-12 container">
                <div class="row center-block">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-2  text-center tamanioVisor thumbnail">
                        <div class="row">
                            <img src="imgs/100x140.png">
                        </div>
                        <div class="row precio">0,50â¬</div>
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-2  text-center tamanioVisor thumbnail">
                        ...
                        <div class="row nombre">1/2 Leche</div>
                         <div class="input-group">
                            <span class="input-group-btn">
                                <button type="button" class="btn btn-danger btn-number btnMenos" data-type="minus" data-field="quant[2]">
                                    <span class="glyphicon glyphicon-minus"></span>
                                </button>
                            </span>
                            <input type="text" name="quant[2]" class="form-control input-number" value="0" min="1" max="100">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-2  text-center tamanioVisor thumbnail">
                        ...
                        <div class="row precio"> <span class="price--line-through">0,50â¬ </span> 0,25â¬</div>
                        <div class="row precioxq">1â¬/litro</div>
                        <div class="row nombre">1/2 Leche</div>
