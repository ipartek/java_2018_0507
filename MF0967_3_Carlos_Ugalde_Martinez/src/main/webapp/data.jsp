							...
							<form id="data-management-form" action="insert" method="post"
								...
								<div class="form-group">
									<label>Edad</label> <input type="number" 
										...
										tabindex="2" maxlength="2" class="form-control"
										placeholder="Edad...">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Peso</label> <input type="text" value="${dog.peso}" 
										name="peso" id="peso" tabindex="4" class="form-control"
										placeholder="Peso...">
								</div>
								<div class="form-group">
									<label>Apadrinado</label> <input type="number" maxlength="1" value="${dog.apadrinado}" 
										name="apadrinado" id="apadrinado" tabindex="5" class="form-control"
										placeholder="1 para apadrinado, otro valor no apadrinado...">
								</div>
								<div class="form-group">
									<label>Chip</label> <input type="text" value="${dog.chip}" 
										name="chip" id="chip" maxlength="12" tabindex="6" class="form-control"
										placeholder="Chip...">
								</div>
								<div class="form-group">
									<label>Latitud</label> <input type="text" value="${dog.latitud}" 
										name="latitud" id="latitud" maxlength="8" tabindex="7" class="form-control"
										placeholder="Latitud...">
								</div>
								<div class="form-group">
									<label>Longitud</label> <input type="text" value="${dog.longitud}" 
								...
								<div class="form-group">
									<div class="row">
										<div class="col-sm-6 col-sm-offset-3">
											...
											<button href="index.jsp" tabindex="10" class="btn btn-danger">Cancelar</button>
										</div>
									</div>
									</div>
							</form>
