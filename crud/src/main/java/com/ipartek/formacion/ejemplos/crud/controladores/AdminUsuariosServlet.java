...
<<<<<<< HEAD
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (accion == null) {
			throw new ControladorException("No se admite una petici√≥n que no tenga accion");
		}
		...
		case "delete":
			...
			break;
		default:
			throw new ControladorException("No se admite una petici√≥n que no sea insert, update o delete");
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		case "insert":
			...
			dao.insert(usuario);
			mensaje = "Inserci√≥n correcta del usuario " + usuario.getEmail();
			break;
		case "update":
			longId = extraerId(id);
			usuario = new Usuario(longId, email, password);
			dao.update(usuario);
			mensaje = "Actualizaci√≥n correcta del usuario " + usuario.getEmail();
			break;
		case "delete":
			longId = extraerId(id);
			dao.delete(longId);
...
=======
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// Dependiendo de la accion querrÈ hacer una cosa u otra
		if (accion == null) {
			throw new ControladorException("No se admite una peticiÛn que no tenga accion");
		}
		...
		case "delete":
			...
			try {
				...
				throw new ControladorException("El id no era numÈrico", e);
			}
			...
			break;
		default:
			throw new ControladorException("No se admite una peticiÛn que no sea insert, update o delete");
		}
