...
/**
 * Servlet implementation class AdminProcesarEdicionServlet
 */
...
public class AdminProcesarEdicionServlet extends HttpServlet {
     ...
     */
    public AdminProcesarEdicionServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			switch (accion) {
			case "add":
				producto = new Producto(nombre,Double.parseDouble(precio),Long.parseLong(id));
