...
<body class="container-fluid">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="btn-group" role="group">
				<a class="btn btn-default" href="ListadoIncidencias">Ver
					Incidencias</a>
			</div>
			<div class="btn-group" role="group">
				<a class="btn btn-default" href="ListadoUsuarios">Ver Usuarios</a>
			</div>
			<div class="btn-group" role="group">
				<a class="btn btn-default" href="ListadoEquipos">Ver Equipos</a>
			</div>
			<div class="btn-group" role="group">
