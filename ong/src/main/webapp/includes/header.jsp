...
<body>
	...
	<nav class="navbar navbar-expand-sm navbar-dark bg-dark fixed-top mb-5">
		...
		<ul class="navbar-nav mr-auto">
				<c:if test="${sessionScope.usuario.nombre == 'scobby'}">
					<li class="nav-item"><i class="fa fa-pencil"></i><a
						class="btn btn-outline-light" href="admin/indexPerros">Administrar perros</a></li>
				</c:if>
			</ul>
				...
				<c:choose>
					...
					<c:otherwise>
						<li class="nav-item"><a class="nav-link"> <span
								class="fa fa-user mr-1"></span>${sessionScope.usuario.nombre}
						</a></li>
