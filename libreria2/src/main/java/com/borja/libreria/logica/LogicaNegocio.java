...
public class LogicaNegocio {
	...
	static {
		...
		usuarios.insert(new Usuario(5, "paulo", "cohelo"));
			...
			paginas.insert(new Pagina(3,"El Error 500 - Internal server error, es un código de estado HTTP muy general que significa que algo ha ido mal en el servidor del sitio web, pero el servidor no puede ser más específico sobre cuál es el problema exacto.\r\n" + 
					"\r\n" + 
					...
					"\r\n" + 
					"HTTP 500 Internal Error","juana"));
			paginas.insert(new Pagina(4, "1. Un error de permisos. En la mayoría de los casos, un error interno del servidor 500 se debe a un permiso incorrecto en uno o más archivos o carpetas. En la mayoría de esos casos, se debe culpar a un permiso incorrecto en un script PHP y CGI .\r\n" + 
					...
					"pedu"));
			paginas.insert(new Pagina(5, "1. Un error de permisos. En la mayoría de los casos, un error interno del servidor 500 se debe a un permiso incorrecto en uno o más archivos o carpetas. En la mayoría de esos casos, se debe culpar a un permiso incorrecto en un script PHP y CGI .\r\n" + 
					...
					"3. Un error de codificación en .htaccess. Aunque no es tan común, asegúrate de verificar que el archivo .htaccess de tu sitio esté estructurado correctamente.", 
					"hulio"));
			paginas.insert(new Pagina(6, "1. Un error de permisos. En la mayoría de los casossefasef, un error interno del servidor 500 se debe a un permiso incorrecto en uno o más archivos o carpetas. En la mayoría de esos casos, se debe culpar a un permiso incorrecto en un script PHP y CGI .\r\n" + 
					...
					"3. Un error de codificación en .htaccess. Aunque no es tan común, asegúrate de verificar que el archivo .htaccess de tu sitio esté estructurado correctamente.", 
					"knuckles"));
			paginas.insert(new Pagina(7, "1. Un error de permisos. En la mayoría de los casos, un error interno del servidor 500 se debe a un permiso incorrecto en uno o más archivos o carpetas. En la mayoría de esos casos, se debe culpar a un permiso incorrecto en un script PHP y CGI .\r\n" + 
