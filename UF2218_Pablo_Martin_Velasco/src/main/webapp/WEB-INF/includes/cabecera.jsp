...
<head>
<meta charset="UTF-8" />
<title>Libro Comunitario Online</title>
...
<body>
	...
	<header>
		<h1>Libro On-Line Comunitario</h1>
	</header>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<c:if test="${not empty user.nombre}">
					<li class="nav-item"><i class="fa fa-pencil"></i><a class="btn btn-outline-light" href="edicion.jsp">Continuar con la historia</a></li>
				</c:if>
			</ul>
