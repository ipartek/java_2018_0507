package com.ipartek.formacion.javaee.cristinaservlets.logica;

import java.math.BigDecimal;
import java.util.List;

import com.ipartek.formacion.javaee.cristinaservlets.accesoadatos.MapDAO;
import com.ipartek.formacion.javaee.cristinaservlets.pojo.Producto;
...
public class LogicaNegocio {
	...
	static {
		...
		/*
		 * long i = 1; // (id), pombre, precio productos.insert(new Producto(i,
		 * "Producto" + i, new BigDecimal(i * 10 + "." + i)));
		 */
