...
CREATE TABLE `facturas_productos` (
  ...
  CONSTRAINT `FK_FACTURAS` FOREIGN KEY (`id_factura`) REFERENCES `facturas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_PRODUCTOS` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`) ON UPDATE CASCADE
...
INSERT INTO `facturas_productos` VALUES (1,1,2),(1,2,5),(2,1,8),(2,2,3);
