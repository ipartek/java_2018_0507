...
CREATE TABLE `reparaciones` (
  ...
  `NombreReparacion` varchar(45) DEFAULT NULL,
  `Comentarios` text,
  ...
  KEY `fk_Reparaciones_Vehiculo1_idx` (`Vehiculo_bastidor`),
  CONSTRAINT `fk_Reparaciones_Vehiculo1` FOREIGN KEY (`Vehiculo_bastidor`) REFERENCES `vehiculo` (`bastidor`)
