...
public class Perros {
	...
	private String raza ="";
	private int peso = 0;
	private boolean apadrinado = true;
	private String chip ="";
	private int latitud = 0;
	private int longitud = 0;
	public Perros(Long id, String nombre, int edad, String raza, int peso, boolean apadrinado, String chip, int latitud,
			int longitud) {
		super();
		this.id = id;
		this.nombre = nombre;
	...
	public String toString() {
		return "Perros [id=" + id + ", nombre=" + nombre + ", edad=" + edad + ", raza=" + raza + ", peso=" + peso
				+ ", apadrinado=" + apadrinado + ", chip=" + chip + ", latitud=" + latitud + ", longitud=" + longitud
				+ "]";
	}
